...
@Public
@Unstable
public class MyHiveMetaStoreClient implements IMetaStoreClient, AutoCloseable {
    ...
    public MyHiveMetaStoreClient(HiveConf conf) throws MetaException {
        this(conf, null, true);
    }

    public MyHiveMetaStoreClient(HiveConf conf, HiveMetaHookLoader hookLoader) throws MetaException {
        this(conf, hookLoader, true);
    }

    public MyHiveMetaStoreClient(HiveConf conf, HiveMetaHookLoader hookLoader, Boolean allowEmbedded)
        ...
        fileMetadataBatchSize = HiveConf.getIntVar(
                conf, ConfVars.METASTORE_BATCH_RETRIEVE_OBJECTS_MAX);
    ...
    private MetaStoreFilterHook loadFilterHooks() throws IllegalStateException {
        Class<? extends MetaStoreFilterHook> authProviderClass = conf.
                getClass(ConfVars.METASTORE_FILTER_HOOK.varname,
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#alter_table(
     *String, String,
     * Table)
     */
    @Override
    public void alter_table(String dbname, String tbl_name, Table new_tbl)
        ...
        alter_table_with_environmentContext(dbname, tbl_name, new_tbl, environmentContext);
//        alter_table_with_environmentContext(dbname, tbl_name, new_tbl, null);
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#rename_partition(
     *String, String, List, Partition)
     */
    @Override
                        ...
                        if (useSSL) {
                            try {
                                ...
                                String trustStorePassword = ShimLoader.getHadoopShims().getPassword(conf,
                                        ConfVars.HIVE_METASTORE_SSL_TRUSTSTORE_PASSWORD.varname);
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#add_partition(Partition)
     */
    @Override
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#add_partitions(List)
     */
    @Override
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#append_partition(String,
     * String, List)
     */
    @Override
    ...
    public List<Partition> exchange_partitions(Map<String, String> partitionSpecs,
                                               String sourceDb, String sourceTable, String destDb,
                                               String destinationTableName) throws MetaException, NoSuchObjectException, InvalidObjectException, TException {
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#create_database(Database)
     */
    @Override
     ...
     * @throws TException
     * @see ThriftHiveMetastore.Iface#create_table(Table)
     */
    @Override
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#create_type(Type)
     */
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#drop_database(String, boolean, boolean)
     */
    @Override
    ...
    public void dropDatabase(String name, boolean deleteData, boolean ignoreUnknownDb, boolean cascade)
        ...
        if (cascade) {
             ...
             * If {@link ConfVars.METASTORE_BATCH_RETRIEVE_MAX}
            ...
            int maxBatchSize = HiveConf.getIntVar(conf, ConfVars.METASTORE_BATCH_RETRIEVE_MAX);
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#drop_partition(String,
     * String, List, boolean)
     */
  ...
  */
     ...
     * @see ThriftHiveMetastore.Iface#drop_table(String,
     * String, boolean)
     */
    public void dropTable(String dbname, String name, boolean deleteData,
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#drop_type(String)
     */
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#get_type_all(String)
     */
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#get_database(String)
     */
    @Override
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#get_partition(String,
     * String, List)
     */
    @Override
     ...
     * @throws TException
     * @throws NoSuchObjectException
     * @see ThriftHiveMetastore.Iface#get_table(String,
     * String)
     */
    @Override
     ...
     * @throws TException
     * @throws NoSuchObjectException
     * @see ThriftHiveMetastore.Iface#get_type(String)
     */
    ...
    private List<TableMeta> filterNames(List<TableMeta> metas) throws MetaException {
        ...
        for (Entry<String, List<String>> entry : dbTables.entrySet()) {
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#get_fields(String,
     * String)
     */
    @Override
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#alter_index(String,
     * String, String, Index)
     */
    @Override
     ...
     * @throws MetaException
     * @throws TException
     * @see ThriftHiveMetastore.Iface#get_schema(String,
     * String)
     */
    @Override
